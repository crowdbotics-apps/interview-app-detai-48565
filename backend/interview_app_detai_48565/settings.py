"""
Django settings for interview_app_detai_48565 project.
...
ROOT_URLCONF = 'interview_app_detai_48565.urls'
...
WSGI_APPLICATION = 'interview_app_detai_48565.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "interview app detailed Support <support@interview-app-detai-48565.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "interview_app_detai_48565 API",
    "DESCRIPTION": "API documentation for interview_app_detai_48565 App",
    "VERSION": "v1",
}
